...
;;
;; This is an updates version of the original org-mode.el implementation
;; of Bernt Hanson, the complete documentation is available at:
;; https://doc.norang.ca/org-mode.html all changes made to the orginal
;; document were made to enable its function in Emacs >=30.
;;
...
(maybe-require-package 'calfw-org)
